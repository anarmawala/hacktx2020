// AIzaSyAVi2Xst6-cJfchOIOx62UbIrl8nF6W7yI
...
export const MapContainer: React.FC = () => {
    return (
        ...
        <div style={{ height: '100vh', width: '100%' }}>
            <GoogleMapReact
                bootstrapURLKeys={{ key: 'AIzaSyAg5CbtGaSGr2NLjeQAUdHa6TL-9eN_o9M', libraries: ['visualization'] }}
                defaultCenter={{
                    lat: 41.95,
                    lng: -87.33,
                }}
                defaultZoom={11}
                heatmap={{
                    positions: [{ lat: 41, lng: -87, weight: 500 }],
                    options: {
                        radius: 500,
                        opacity: 1,
                    },
